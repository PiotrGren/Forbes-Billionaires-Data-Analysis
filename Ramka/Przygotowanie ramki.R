#PROJEKT GRUPOWY - CZÊŒÆ I - PRZYGOTOWANIE RAMKI DANYCH
#Kiwacka Gabriella
#Greñ Piotruœ

#Temat: Forbes Miliarderzy

setwd("C:/Users/Piotrek/Desktop/Uczelnia/Programowanie w R/Projekt Koñcowy/Ramka")
list.files()
...
#pobranie w³aœciwej ramki danych
...
#pobranie imion do wektora w celu w³¹czenia do ramki danych o wartoœci z innych lat
...
#usuniêcie wszystkich spacji w wektorach
names <- gsub(" ", "", names)
names21 <- gsub(" ", "", names21)

#stworzenie wektora, z posortowanymi odpowiednio wartoœciami pieniê¿nymi do nazwisk miliarderóW
networth21 <- 1:2600
...
#w³¹czenie do ramki nowego wektora
billionaires <- cbind(billionaires, "2021" = networth21)

#powtórzenie czynnoœci jak przy pierwszej ramce danych 
...
write.csv(billionaires, "C:/Users/Piotrek/Desktop/Uczelnia/Programowanie w R/Projekt Koñcowy/Forbes_Billionaires_Projekt.csv")
